...
/// </summary>
/// <seealso cref="Microsoft.EntityFrameworkCore.Design.IDesignTimeDbContextFactory&lt;TestOrderService.Infrastructure.Data.PatientTestOrderServiceDbContext&gt;" />
public class TestOrderServiceDbContextFactory : IDesignTimeDbContextFactory<TestOrderServiceDbContext>
{
    ...
    public TestOrderServiceDbContext CreateDbContext(string[] args)
    {
        var configuration = new ConfigurationBuilder()
            .SetBasePath(Path.Combine(Directory.GetCurrentDirectory(), "../TestOrderSerivce.API"))
